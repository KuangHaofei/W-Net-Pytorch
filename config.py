class Config():
    def __init__(self):
        ...
        self.batch_size = 16  # Batch size of patches Note: 11 gig gpu will max batch of 5
        ...
        self.data_dir = "/home/ubuntu/workspace/W-Net-Pytorch/datasets/BSDS300/"  # Directory of images
